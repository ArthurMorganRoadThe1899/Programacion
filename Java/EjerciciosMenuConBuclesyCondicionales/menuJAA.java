package Programacion.Java.EjerciciosMenuConBuclesyCondicionales;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (eleccion == 3) {
                ...
                System.out.println();
                System.out.println("Muy bien, pues dame números, si quieres cancelar escribe un número negativo");
            ...
            if (eleccion == 4) {
                System.out.println();
                System.out.println("Muy bien, dame un número, y te hago cuenta regresiva");

                for (int respuesta = in.nextInt(); respuesta > 0; respuesta--){
