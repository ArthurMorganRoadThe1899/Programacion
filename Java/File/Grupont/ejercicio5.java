...
public class ejercicio5 {
    ...
    public static void write(File p, String month, String startingMonthDay, int numberMonthDays){
        ...
        try {
            ...
            switch (weekDaySelector(dayUpgrader)){
                case "lunes":
                    bufbuf.newLine();
                    bufbuf.write(" " + 1);
                    break;
            ...
            for(int i = 2; i < numberMonthDays+1; i++){
                switch (weekDaySelector(dayUpgrader)){
                    default:
                        // Este if else tiene el próposito de que a partir de números de 2 cifras se reduzca la separación en 1 para que no se rompa xD
                        if(i <= 10){
                            bufbuf.write("    " + i);
                        }else{
                            bufbuf.write("   " + i);
